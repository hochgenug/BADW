...
;    $(this).children('.showItem__col--3').children('.actions').append(getLinks(getSearchUrl('ZT', serieName), getSearchUrl('T411', serieName)) + '<div class="actionButton" onclick="checkAll(this)" style="position: absolute;left: 96px;color: black;height: 20px;"><img style="height:20px;" src="'+checkImage+'"></div>')
});
...
function getSearchUrl(provider, serie) {
    ...
    switch (provider) {
        case 'ZT':
            ...
            break;
        case 'T411':
            searchLink = "http://torrent411.xyz//torrents/search/?search=";
            break;
    }
